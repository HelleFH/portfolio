...
const Footer = () => {
  return (
    <footer className="flex flex-col md:flex-row justify-between items-center bg-white border-t border-gray-300 p-6 w-full mt-6 font-roboto">
      ...
      <div className="flex justify-center items-center flex-col gap-2 flex-1 text-center md:text-left">
        ...
        <a
          ...
          className="text-green-800 hover:text-green-600 transition-colors text-lg font-medium"
        >
